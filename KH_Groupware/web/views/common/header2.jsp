...
<div id= outerDiv>;  
	<div id= "menuBar" >
			<div class =" logoImg" style="line-height:50px;" "><img  id =logoImg src="../../images/logoImg.png" onclick= "location.href = '<%=request.getContextPath()%>/views/common/mainHome.jsp'""></div>
	...
	<div id= "teacherDiv" class="subMenu" data-value = "0">
	 ...
	 <div id= "loginDiv" class="loginDiv" data-value = "0">
		<div class=loginArea style="align:center;margin-top:40px">
			...
			<button class = " blackBtn blackBtn1" type = "submit" onclick = "login();" type="button">로그인</button><br><br><br>
			<button class = "blackBtn blackBtn2"  type = "submit" type="button">아이디 / 비밀번호 찾기</button>
		</div>
		...
		<div class=joinArea>
			<div>
				...
				<br><br><br>	
				<button class = " blackBtn blackBtn1" type = "submit" onclick = "login();" type="button" onclick = "memberJoin();">회원가입</button><br><br><br>
			</div>
		</div>
	</div>
