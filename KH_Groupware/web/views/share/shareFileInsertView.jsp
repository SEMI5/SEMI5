...
<hr>
		...
		<table id = "S-table" border= "1";>
			<tr>
				...
				<td><input id = "title" type ="text" placeholder="제목을입력하세요" style="width:900px; height:35px;"></td>
			</tr>
			<tr>
				<th width = "200px"  height = "100px">작성자*</th>
				<td><input  type ="text" style="height:35px;" value = "<%=loginUser.getUserName() %>" readonly> </td>
			</tr>
			<tr>
			...
			<!-- 	<th colspan="2" height = "50px">내용</th> -->
				<td colspan="2">
			 	...
			 	<td colspan ="2">
			 	<textarea name = "content" rows="9" cols ="180" size ="resize:none"></textarea>
