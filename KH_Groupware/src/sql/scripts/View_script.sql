...
AS 
SELECT ROWNUM RNUM, BID, CID, BTITLE, BCONTENT, BTYPE, USER_NAME, BCOUNT, CREATE_DATE, MODIFY_DATE, STATUS, BLEVEL
FROM (SELECT B.BID, B.CID, B.BTITLE,B. BCONTENT,B.BTYPE, M.USER_NAME, B.BCOUNT, B.CREATE_DATE, B.MODIFY_DATE, B.STATUS, B.BLEVEL
      FROM N_BOARD B
...
AS 
SELECT B.BID, B.CID, B.BTITLE,B. BCONTENT,B.BTYPE, M.USER_NAME, B.BCOUNT, B.CREATE_DATE, B.MODIFY_DATE, B.STATUS, B.BLEVEL
      FROM N_BOARD B
      JOIN MEMBER M ON(B.BWRITER = M.USER_NO)
      WHERE B.STATUS = 'Y';
