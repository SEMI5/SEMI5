...
public class Thumbnail implements Serializable {
	...
	public Thumbnail(int bId, int cId, String bTitle, String btype, String bContent, int bCount, String bWriter,
	...
	public String toString() {
		return "Thumbnail [bId=" + bId + ", cId=" + cId + ", bTitle=" + bTitle + ", btype=" + btype + ", bContent="
