...
/**
 * Servlet implementation class SFileInsertServlet
 */
@WebServlet("/insert.sh")
public class SFileInsertServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SFileInsertServlet() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(ServletFileUpload.isMultipartContent(request)) {
			...
			// 3_1. 파일 외에 게시판 제목, 내용, 작성자 회원 번호 받아오기
						...
						int result = new SFileService().insertSFile(fileList);
						...
						if(result > 0) {
							...
							request.setAttribute("msg", "자료실 등록실패!!");
