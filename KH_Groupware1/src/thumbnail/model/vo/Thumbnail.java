...
public class Thumbnail implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -5029771673693624043L;
	
	private int bId;			//게시판 고유 번호
	private int bType;			//게시판 타입 (1. 일반게시판, 2.사진 게시판)
	...
	public Thumbnail(int bId, int bType, String cId, String bTitle, String bContent, String bWriter, int bCount,
	...
	public String toString() {
		return "Thumbnail [bId=" + bId + ", bType=" + bType + ", cId=" + cId + ", bTitle=" + bTitle + ", bContent="
